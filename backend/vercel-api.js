 ...
 * Converts Express.js server to Vercel serverless function
 */
...
// CORS configuration
app.use(cors({
  origin: process.env.FRONTEND_URL || 'https://careerlens-ai.vercel.app',
  credentials: true,
}));
...
const oauth2Client = new google.auth.OAuth2(
  ...
  process.env.GOOGLE_REDIRECT_URI || 'https://careerlens-ai.vercel.app/auth/callback'
);
